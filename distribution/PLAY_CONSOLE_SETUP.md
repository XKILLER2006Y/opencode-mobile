...
cat /path/to/service-account.json | \
  gh secret set PLAY_STORE_SERVICE_ACCOUNT_JSON --repo XKILLER2006Y/opencode-mobile
```
...
```bash
gh workflow run publish-play-store.yml --repo XKILLER2006Y/opencode-mobile
```
