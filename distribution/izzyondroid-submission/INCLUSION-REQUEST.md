...
**GitHub releases:** https://github.com/XKILLER2006Y/opencode-mobile/releases
...
```
https://github.com/XKILLER2006Y/opencode-mobile/releases/download/<TAG>/app-release.apk
```

Example (first production release):
```
https://github.com/XKILLER2006Y/opencode-mobile/releases/download/v0.4.2/app-release.apk
```
...
- Source code is fully public: https://github.com/XKILLER2006Y/opencode-mobile
- License: MIT (https://github.com/XKILLER2006Y/opencode-mobile/blob/main/LICENSE
...
Privacy policy: https://XKILLER2006Y.github.io/opencode-mobile/privacy/
