...
4. **Privacy policy URL** — live & verified at https://XKILLER2006Y.github.io/opencode-mobile/privacy/ (this GitHub Pages URL is the canonical privacy URL used for store submissions; if the owner later deploys the branded `agentlabs.cc/opencode/privacy`, it can replace it — reversible). Template in `play-listing.md`.
...
2. File issue at https://codeberg.org/IzzyOnDroid/repodata/issues:
   ...
   License: MIT
   GitHub release: https://github.com/XKILLER2006Y/opencode-mobile/releases
   APK SHA-256: <sha256>
