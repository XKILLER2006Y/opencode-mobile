...
**Remediation:**
1. Update the canonical privacy policy at `https://XKILLER2006Y.github.io/opencode-mobile/privacy/` to explain that the app connects to user-configured server addresses that may use HTTP.
